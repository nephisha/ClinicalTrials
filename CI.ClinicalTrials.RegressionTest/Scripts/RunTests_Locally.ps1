[String]$PackageLocation="D:\Applications\Test\Cinsw.ClinicalTrials.RegressionTest\1.9.0-alpha56"
[String]$NUnitCategory="Working"
[String]$ReportLocation="C:\Temp"
...
$runNUnit = "& $NUnitExecutablePath $NUnitTestAssemblies --trace=Verbose --framework=net-4.5 --shadowcopy --work=$ResultDir --labels=All --output=$ResultFileName --where $Category"
